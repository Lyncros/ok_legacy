...
if (!$validador->ocurrieronErrores()) {
	...
	$mensaje .= "<b>Nombre:</b> $_POST[apellido] <br/>";
	...
	//envia el mail
	enviar_mail("inmobiliaria@okeefe.com.ar", "Nuevo mensaje desde la landing de Rural", $mensaje, $_POST[email], $_POST[nombre]." ".$_POST[apellido]);
