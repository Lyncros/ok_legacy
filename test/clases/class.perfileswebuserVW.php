...
class PerfileswebuserVW extends VW {
...
*/	
	...
	public function vistaTablaVW() {
		...
		print "function envia(nameForm,opcion,id,perfil){\n";
...
//		$menu->dibujaMenu ( 'lista', 'opcion' );
		...
		if (sizeof ( $arrayEven ) == 0) {
			...
			foreach ( $arrayEven as $Even ) {
				...
				print "    <a href='javascript:envia(\"lista\",8242," . $Even ['id_user'] .",\"". $Even ['perfil'] ."\");' border='0'>";
				print "       <img src='images/building_edit.png' alt='Editar' title='Editar' border=0></a></td>";
				print "	 <td  align='center' width='25' class='row" . $fila . "'>";
				print "    <a href='javascript:envia(\"lista\",8243," . $Even ['id_user'] .",\"". $Even ['perfil'] . "\");' border=0 onclick=\"return confirm('Esta seguro que quiere eliminar este registro?');\">";
