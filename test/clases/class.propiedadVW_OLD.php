...
*/
    ...
    public function leeDatosPropiedadVW() {
        ...
        if ($_POST['publicadir'] == "on") {
            $_POST['publicadir'] = 1;
        }
        if ($_POST['destacado'] == "on") {
            $_POST['destacado'] = 1;
        }
        if ($_POST['oportunidad'] == "on") {
            $_POST['oportunidad'] = 1;
        }
        if ($_POST['activa'] == "on" || $_POST['activa'] == 1) {
            $_POST['activa'] = 1;
        }else{
            $_POST['activa'] = 0;
        }
...
//	    if(strtoupper($perfGpo) != 'STAFF'){ $arrayTools[] = array('Modificar', 'images/building--pencil.png', 'menuTools(2)');}
	    if(strtoupper($perfGpo) != 'STAFF'){ $arrayTools[] = array('Borrar', 'images/building--minus.png', 'menuTools(3)');}
...
//echo "PREVIO <br>";print_r($arrayDatos);
        ...
        $this->deslpiegaTabla($arrayDatos, $registros,$totalregs, $pagina);
        print "</div>";
    ...
    public function deslpiegaTabla($arrayDatos, $registros,$totalregs, $pagina) {
...
//        $arrayEven = array_slice($arrayDatos, (($pagina - 1) * $registros), $registros);   // AGREGADO PARA UNIFICAR BUSQUEDA
        ...
        if (sizeof($arrayEven) == 0) {
            ...
            foreach ($arrayEven as $Even) {
                ...
                // Defino informacion 
                $onclick = " onclick=\"javascript: ventana('muestra_datosprop.php?i=" . $Even['id_prop'] . "', 'Datos de la propiedad', 980, 900);\"";
...
//			}
            ...
            $mensaje .= "  <tr>\n";
            $mensaje .= "    <td width=\"680\" style=\"font-weight: bold; font-size:12pt;color:#008046;\"><a href=\"http://www.okeefe.com.ar/detalleProp.php?iddest=".$id_prop."\" style=\"color:#008046; text-decoration: none;\">" . substr($arrayDatos [0] ['contenido'], 0, 100) . "</a></td>\n";
