...
//	Cliente::setId_cli($id_cli);
    ...
    public function seteaCliente($_login) {
        ...
        $this->setCapcompra($_login->getCapcompra());
        $this->setNews($_login->getNews());
        $this->setCategoria($_login->getCategoria());
        $this->setTipocont($_login->getTipocont());
        $this->setAsignacion($_login->getAsignacion());
        $this->setSexo($_login->getSexo());
    }
    ...
    public function setCategoria($categoria) {
        ...
        public function getCapcompra() {
        return $this->capcompra;
    }

    public function setCapcompra($capcompra) {
        $this->capcompra = $capcompra;
    }
    ...
    public function __toString() {
        ...
        $str.='Cap compra: ' . $this->getCapcompra() . '; ';
        $str.='News: ' . $this->getNews() . '; ';
        $str.='Tipo Contacto: ' . $this->getTipocont() . '; ';
        $str.='Categoria: ' . $this->getCategoria() . '; ';
        $str.='Asignacion: ' . $this->getAsignacion() . '; ';
