...
class CaracteristicaBSN extends BSN {
    ...
    /**
     * Retorna un array con los datos de todas las caracteristicas definidas para el buscador
     * @return array [][] 
     */
    public function coleccionBuscadorCompleto(){
        $datoDB = new CaracteristicaPGDAO();
        $array = $this->leeDBArray($datoDB->coleccionCaracBuscador(''));
        return $array;
    }
