...
class Datosprop {
	...
	$id_tipo=0
		...
		Datosprop::setPublica($publica);
		Datosprop::setPublica($tipo_publica);
		Datosprop::setId_tipo($id_tipo);
	...
	public function seteaDatosprop($_datos){
		...
		$this->setPublica($_datos->getPublica());
		$this->setPublica($_datos->getTipo_publica());
		$this->setId_tipo($_datos->getId_tipo());
	...
	public function setTipo_publica($tipo_publica){
		$this->tipo_publica=$tipo_publica;
	}
	...
	public function getTipo_publica(){
		return $this->tipo_publica;
	}
