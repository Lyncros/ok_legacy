...
/**
 *Inserta como pendiente una tasacion
 * @param int $_id_prop -> id de la propiedad a ser tasada o retasada
 */
        public function insertaTasacionPendiente($id_prop=0,$fecha,$comentario=''){
            if($id_prop!=0){
                $tas= new Tasacion(0,$id_prop,0,'Pendiente',$fecha,'',$comentario);
                $tasBSN = new TasacionBSN($tas);
                $tasBSN->insertaDB();
            }
        }
 ...
 * @param int $_id_prop -> id de la propiedad a ser tasada o retasada
 */
        public function insertaTasacionRetirada($id_prop=0,$fecha,$comentario=''){
            if($id_prop!=0){
                $tas= new Tasacion(0,$id_prop,0,'Retirado',$fecha,'',$comentario);
                $tasBSN = new TasacionBSN($tas);
                $tasBSN->insertaDB();
            }
        }
 ...
 * @param int $_id_prop -> id de la propiedad a ser tasada o retasada
 */
        public function insertaTasacionCumplida($id_prop=0,$fecha,$comentario=''){
            if($id_prop!=0){
                $tas= new Tasacion(0,$id_prop,0,'Tasado',$fecha,'',$comentario);
                $tasBSN = new TasacionBSN($tas);
                $tasBSN->insertaDB();
            }
        }
