...
class IngresoclienteBSN extends BSN {
    ...
    public function cargaByCliente($id = 0) {
        ...
        if ($id != 0) {
            ...
            $dato = $arrayDatos[0];
                $retorno->setId_ingreso($dato['id_ingreso']);
                $retorno->setId_cli($dato['id_cli']);
                $retorno->setId_fingreso($dato['id_fingreso']);
                $retorno->setId_fcontacto($dato['id_fcontacto']);
                $retorno->setId_promo($dato['id_promo']);
                $retorno->setUsr_carga($dato['usr_carga']);
                $retorno->setFec_cont($dato['fec_cont']);
            }
        }
        return $retorno;
    }
