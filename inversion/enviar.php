...
$validador->validarCampoForm ("inversion");

if (! $validador->ocurrieronErrores ())
{
	// mensaje para mail
	$mensaje .= "<b>Inversi&oacute;n:</b> " . $_POST['inversion'] . " <br/>";
	...
	$db->query ("INSERT INTO contacto SET fechaAlta=CURDATE(), inversion='" . $_POST['inversion'] . "',nombre='" . $_POST['nombre'] . "',apellido='" . $_POST['apellido'] . "', email='" . $_POST['email'] . "', tel='" . $_POST['tel'] . "', consulta='" . $_POST['consulta'] . "'".$sqlUTM);
	
	// envia el mail
	enviar_mail ("juancruz@okeefe.com.ar", "Nuevo mensaje desde la landing INVERSION DE CAPITAL Y RENTA", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
	//enviar_mail ("ivanberlot@gmail.com", "Nuevo mensaje desde la landing INVERSION DE CAPITAL Y RENTA", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
	//enviar_mail ("victoria@eldodo.com.ar", "Nuevo mensaje desde la landing INVERSION DE CAPITAL Y RENTA", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
