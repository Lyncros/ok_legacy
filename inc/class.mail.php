...
class mail {
  ...
  public static function send($head, $subject, $body, $attachments=array()) {
    ...
    $headKeys = array_keys($head['from']);
    $headValues = array_values($head['from']);
    $fromaddress = array_pop($headKeys);
    $fromname    = array_pop($headValues);
    $eol="\r\n";
    ...
    $headers .= "E-mail software does not support MIME-formatted messages.".$eol;
