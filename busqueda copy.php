...
<?php include_once('cabezalBuscador.php'); ?>
  ...
  <div id="placaBusqueda"><?php echo $txtFiltro; ?></div>
  </div>
  <?php
  if(count($prop) > 0){
    for($i=0; $i < count($prop); $i++) {
...
*/        
  ...
  <div id="resultado">
    <div id="fotoResul" onclick="javascript: detalleProp(<?php echo $id_prop; ?>);"  border="0" style="cursor: pointer;">
      <?php if($fotos[0]['foto'] != "") { ?>
      <img src="http://abm.okeefe.com.ar/fotos_th/<?php echo $fotos[0]['foto']; ?>" width="160" height="107" border="0" style="cursor: pointer;" />
      <?php }else { ?>
