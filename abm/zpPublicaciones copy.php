...
<div class="pg_titulo">Publicaciones en ZonaProp</div>
<form action="publicaZonaProp.php" method="post" id="zp" name="zp">
...
<div style="padding:5px 20px;">
	<div style="padding: 10px; float: left; width: 150px;"><input type="radio" name="accion" value="1" onclick="muestraResp(1);" /> Publicar</div>
	<div style="padding: 10px; float: right; width:150px;"><input type="radio" name="accion" value="0" onclick="muestraResp(0);" /> Retirar</div>
	<div style="clear:both;"></div>
<div id="responsable" style="display:none; width: 300px; padding: 10px;">
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("operador","email", "Ingrese una cuenta de email v‡lida");
