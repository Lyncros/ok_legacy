...
class CaracteristicaPGDAO extends PGDAO {
	...
	protected $INSERT = "INSERT INTO #dbName#.caracteristica (id_tipo_carac,titulo, tipo,maximo,comentario,lista,orden,publica) values (#id_tipo_carac#,'#titulo#','#tipo#',#maximo#,'#comentario#','#lista#',#orden#,#publica#)";
	...
	protected $UPDATE = "UPDATE #dbName#.caracteristica SET id_tipo_carac=#id_tipo_carac#, titulo='#titulo#', tipo='#tipo#',maximo=#maximo#,comentario='#comentario#',lista='#lista#',orden=#orden#,publica=#publica# WHERE id_carac=#id_carac# ";
	
	protected $FINDBYID = "SELECT id_carac,id_tipo_carac,titulo, tipo,maximo,comentario,lista,orden,publica FROM #dbName#.caracteristica WHERE id_carac=#id_carac#";
	
	protected $FINDBYCLAVE = "SELECT id_carac,id_tipo_carac,titulo, tipo,maximo,comentario,lista,orden,publica FROM #dbName#.caracteristica WHERE titulo LIKE  '#titulo#'";
	
	protected $COLECCIONBYTIPO = "SELECT id_carac,id_tipo_carac,titulo, tipo,maximo,comentario,lista,orden,publica FROM #dbName#.caracteristica WHERE id_tipo_carac=#id_tipo_carac# ORDER BY id_tipo_carac,orden";
	
	protected $COLECCION = "SELECT id_carac,id_tipo_carac,titulo, tipo,maximo,comentario,lista,orden,publica  FROM #dbName#.caracteristica ORDER BY id_tipo_carac,orden";
