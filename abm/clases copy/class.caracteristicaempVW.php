...
class CaracteristicaempVW {
	private $caracteristicaemp;
	private $arrayForm;
	...
	public function cargaDatosCaracteristicaemp() {
...
//		print "<td width='85%'><input class='campos' type='text' name='orden' id='orden' value='" . $this->arrayForm ['orden'] . "' maxlength='2' size='10'></td><td><span class='obligatorio'>&nbsp;&bull;</span></td></tr>\n";
	...
	public function leeDatosCaracteristicaempVW() {
...
//		print_r ( $_POST );
	...
	public function vistaTablaCaracteristicaemp() {
		$fila = 0;
		print "<script type='text/javascript' language='javascript'>\n";
		...
		print "}\n";
		print "</script>\n";
		print "<span class='pg_titulo'>Listado de Caracteristicas de Emprendimientos</span><br><br>\n";
		...
		if (sizeof ( $arrayEven ) == 0) {
			...
			foreach ( $arrayEven as $Even ) {
				...
				print "    <a href='javascript:envia(162," . $Even ['id_carac'] . ");' border='0'>";
				print "       <img src='images/building_edit.png' alt='Editar' title='Editar' border=0></a></td>";
				print "	 <td align='center' width='25' class=\"row" . $fila . "\">";
				print "    <a href='javascript:envia(163," . $Even ['id_carac'] . ");' border=0 onclick=\"return confirm('Esta seguro que quiere eliminar este registro?');\">";
				print "       <img src='images/delete.png' alt='Borrar' title='Borrar' border=0></a>";
				print "  </td>\n";
				print "	 <td align='center' width='25' class=\"row" . $fila . "\">";
				print "    <a href='javascript:envia(164," . $Even ['id_carac'] . ");' border='0'>";
				print "       <img src='images/up.png' alt='Subir' border=0></a></td>";
				print "	 <td align='center' width='25' class=\"row" . $fila . "\">";
				print "    <a href='javascript:envia(165," . $Even ['id_carac'] . ");' border=0>";
	...
	public function grabaModificacion() {
		...
		if ($retUPre) {
			...
			$retorno = true;
//			$this->grabaCaracteristicaemp_Tipoprop ();
		} else {
			echo "Fallo la grabación de los datos<br>";
		}
		return $retorno;
	}
	public function grabaCaracteristicaemp() {
		$retorno = false;
		$caracteristicaemp = new CaracteristicaempBSN ( $this->caracteristicaemp );
