...
//		print "</script>\n";
		...
		echo "</tr>";
//		echo "</tr><tr>";
//		echo '<td colspan="2" align ="center">Codigo de Verificación <img src="'.$_codseg.'" alt="" width="150" height="50" /><br /><br /><span class="titulos-01">Ingrese el Codio de Verificación de la Imagen:</span> <input type="text" size="8" maxlength="8" name="code" id="code" value="" /></td>';
//		echo "</tr><tr>";
		echo "</tr>";
