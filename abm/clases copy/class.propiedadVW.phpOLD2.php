...
class PropiedadVW {
    ...
    public function cargaDatosPropiedad($id_cli=0) {
        ...
        print "<tr><td class='pg_titulo'>Carga de Propiedades</td></tr>\n";
        ...
        print "<td width='35%'><input class='campos' type='text' name='entre1' id='entre1' value='". $this->arrayForm['entre1'] ."' maxlength='250' size='80'></td>\n";

        print "<td class='cd_celda_texto' width='15%'> y </td>";
        print "<td width='35%'><input class='campos' type='text' name='entre2' id='entre2' value='". $this->arrayForm['entre2'] ."' maxlength='250' size='80'></td></tr>\n";

        print "<tr><td class='cd_celda_texto' width='15%'>Nombre de Edificio </td>";
        print "<td width='90%' colspan='3'><input class='campos' type='text' name='nomedif' id='nomedif' value='". $this->arrayForm['nomedif'] ."' maxlength='250' size='80'></td></tr>\n";
...
//        print "alert(document.forms.lista.id_prop.value);\n";
        ...
        print "	    window.open('muestraSelectorLocalidad.php?l='+elemZona+'&v='+elemLoca,'Seleccion de Localidad', 'location=1,status=1,scrollbars=1, width=630,height=600');\n";
        print "  } else {\n";
        ...
        print "	    window.open('muestraSelectorTipoprop.php?v='+elemProp,'Seleccion de Tipo de Propiedad', 'location=1,status=1,scrollbars=1, width=630,height=600');\n";
        print "}\n";
        print "function popupOperacion() {\n";
        print "	    elemOper=document.getElementById('aux_operacion').value;\n";
        print "	    window.open('muestraSelectorOperacion.php?v='+elemOper,'Seleccion de Tipo de Operacion', 'location=1,status=1,scrollbars=1, width=630,height=600');\n";
        print "}\n";
...
//        $menu->dibujaMenu('lista');
        ...
        print "  <table class='cd_tabla' width='100%'>\n";
        print "    <tr>\n";
        print "     <td class='cd_lista_filtro' style='text-align: left; padding-left: 10px;'>Filtrar por </td>";
        print "	</tr>";
        print "<tr>\n";
        print "		<td class='cd_celda_texto'>Código<br /><input class='campos' name='aux_codigo' id='aux_codigo' type='text' value='$aux_codigo'></td>";
        print "	</tr>";
        print "<tr>\n";
        print "		<td class='cd_celda_texto'>Calle<br /><input class='campos' name='aux_calle' id='aux_calle' type='text' value='$aux_calle'></td>";
        print "	</tr>";
        print "<tr>\n";
        print "		<td class='cd_celda_texto'>Zona<br />";
        $zona1BSN = new ZonaBSN ();
        $zona1BSN->comboZona($aux_zona,$aux_loca,3,'aux_zona','aux_loca');
        print "</td>\n";
        print "	</tr>";
        print "<tr>\n";
        print "		<td class='cd_celda_texto'>Localidad<input type='button' class='campos' value=\"Seleccionar\" id='ver' name='ver' onclick='javascript: popupLocalidad();'>";
        print "     <input class='campos' name='aux_loca' id='aux_loca' type='hidden' value='$aux_loca'></td>";
        print "	</tr>";
        print "<tr>\n";
        print "		<td class='cd_celda_texto'>Tipo de Prop.<br /><input type='button' class='campos' value=\"Seleccionar\" id='ver' name='ver' onclick='javascript: popupTipoprop();'>";
        print "     <input class='campos' name='aux_prop' id='aux_prop' type='hidden' value='$aux_prop'></td>";
        print "	</tr>";
        print "<tr>\n";
        print "		<td class='cd_celda_texto'>Operacion<input type='button' class='campos' value=\"Seleccionar\" id='ver' name='ver' onclick='javascript: popupOperacion();'>";
        print "     <input class='campos' name='aux_operacion' id='aux_operacion' type='hidden' value='$aux_operacion'></td>";
        print "</tr>\n";

        if(isset($_POST['fid_codigo']) && $_POST['fid_codigo']!=0) {
            $aux_codigo=$_POST['fid_codigo'];
        }else {
            $aux_codigo=0;
        }
        if(isset($_POST['fid_calle']) && $_POST['fid_calle']!='') {
        ...
        if(isset($_POST['foperacion']) && $_POST['foperacion']!='') {
            $aux_operacion=str_replace("\\","",$_POST['foperacion']);
        }else {
            $aux_operacion='';
        }
        ...
        print "	<td>";
        print "     <input class='campos' name='aux_codigo' id='aux_codigo' type='text' value='$aux_codigo'></td>\n";
        print "	</td>";
        print "	<td>";
        print "     <input class='campos' name='aux_calle' id='aux_calle' type='text' value='$aux_calle'></td>\n";
        print "	</td>";
        ...
        print "<td><input type='button' class='campos' value=\"Seleccionar\" id='ver' name='ver' onclick='javascript: popupLocalidad();'>";
        print "     <input class='campos' name='aux_loca' id='aux_loca' type='hidden' value='$aux_loca'></td>\n";
...
//        $tipo_propBSN->comboTipoProp($aux_prop,3,'aux_prop','campos','filtro');
        print "<td><input type='button' class='campos' value=\"Seleccionar\" id='ver' name='ver' onclick='javascript: popupTipoprop();'>";
        print "     <input class='campos' name='aux_prop' id='aux_prop' type='hidden' value='$aux_prop'></td>\n";
        print "</td>";

//        print "<td>";
//        armaTipoOperacion($aux_operacion,1,'aux_operacion',0);
        print "<td><input type='button' class='campos' value=\"Seleccionar\" id='ver' name='ver' onclick='javascript: popupOperacion();'>";
        print "     <input class='campos' name='aux_operacion' id='aux_operacion' type='hidden' value='$aux_operacion'></td>\n";
        print "</td>\n";
...
//        print "     <td class='orden_tab'>Sup.Cubierta</td>\n";
        print "     <td class='orden_tab'><a href='javascript:ordenar(7);'><img src='images/" . $img7 . "' id='img_7' border='0'>&nbsp;Amb.</a></td>\n";
//        print "     <td class='orden_tab'><a href='javascript:ordenar(8);'><img src='images/" . $img8 . "' id='img_8' border='0'>&nbsp;Val. Alquiler</a></td>\n";
        ...
        $evenBSN=new PropiedadBSN();
        //		$arrayEven=$evenBSN->cargaColeccionForm();
        $arrayEven=$evenBSN->cargaColeccionFiltroBuscador($aux_codigo,$aux_calle,$aux_zona,$aux_loca,$aux_prop,$aux_operacion,0,$propsIN, $pagina,$aux_campo,$aux_orden );

        $cantreg=$evenBSN->cantidadRegistrosFiltroBuscador($aux_codigo,$aux_calle,$aux_zona,$aux_loca,$aux_prop,$aux_operacion,0,$propsIN);
//		$paginas=intval($cantreg/$registros)+1;
        $cantr=$cantreg/$registros;
        $cante=$cantreg%$registros;
