...
//		print "<td width='10%'><input class='campos' type='text' name='orden' id='orden' value='" . $this->arrayForm ['orden'] . "' maxlength='2' size='10'></td></tr>\n";
...
//		print "      alert('Cargaste '+compara);\n";
		...
		print "}\n";
		print "</script>\n";
		print "<span class='pg_titulo'>Listado de Caracteristicas de Propiedades</span><br /><br />\n";
...
//		print "<form name='lista' method='POST' action='respondeMenu.php'>\n";
		...
		if (sizeof ( $arrayEven ) == 0) {
			...
			foreach ( $arrayEven as $Even ) {
				...
				print "	 <td  align='center' width='25' class='row" . $fila . "'>";
				print "    <a href='javascript:envia(123," . $Even ['id_carac'] . ");' border=0 onclick=\"return confirm('Esta seguro que quiere eliminar este registro?');\">";
				...
				if(array_search($Even['id_carac'],$arrayBuscador)===false){
					...
					print "       <img src='images/buscador.png' alt='Buscador' title='Buscador' border=0></a></td>";
				}else{
					print "	 <td  align='center' width='25' class='row" . $fila . "'>";
					print "    <a href='javascript:envia(1262," . $Even ['id_carac'] . ");' border='0'>";
	...
	public function tablaBuscadorCaracteristica(){
		...
		if (sizeof ( $arrayEven ) == 0) {
			...
			foreach ( $arrayEven as $Even ) {
				...
				print "<tr>\n";
				print "	 <td  align='center' width='25' class='row" . $fila . "'>";
				print "    <a href='javascript:envia(1261," . $Even ['id_carac'] . ");' border='0'>";
