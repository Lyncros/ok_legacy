...
*/
	...
	$mail->Password = "df34SA2%fd";                                   // SMTP password

	$mail->From = $_POST['desde'];
	$mail->FromName = 'Okeefe Propieades';
	...
	$mail->CharSet="UTF-8";
	$mail->AddAttachment('pdfs/' .$nombre, $nombre);    	// optional name
