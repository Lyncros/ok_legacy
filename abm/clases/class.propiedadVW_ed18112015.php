...
*/
        echo " jQuery.support.cors = true;";
        print "var base_url='http://www.okeefe.com.ar/api/';\n";

        echo "$(\"a[id*='zonaprop_']\").each(function() {
                $(this).click(function(event){;
                    ...
                    .fail(function() {
                        alert(\"Error al consultar usuario actual\");
                    });                     
                    ...
                    .done(function(data) {
                        ...
                        if(data.length!=0 && data.length>3){
                            $('#mensaje').html('Esta propiedad ya fue Publicada<br/>Fecha de publicación '+obj[0]['publicada']+'<br/>Publicó '+obj[0]['publico']);
                            $('#content-publicacion').hide();
                            $('.ui-dialog-buttonset button:nth-child(1)').hide();
                            $('.ui-dialog-buttonset button:nth-child(2)').hide();      
                    ...
                    .fail(function() {alert(\"Error al consultar registro ZP\");});  
 
                    
                    $(\"#zp_responsable option\").remove();      
                    ...
                    .done(function(data) {
                        ...
                        $(\"#zp_responsable\").append(\"<option value='0' SELECTED >Seleccione una opcion</option>\");
                        $.each(obj, function(index, val) {
                            $(\"#zp_responsable\").append(\"<option value=\"+val.key+\" >\"+val.value+\" </option>\")
                        });
                    })
                             ...
                             [
                                {
                                  ...
                                  click: function(e) {
                                        e.preventDefault();
                                        var urlTodebug = \"http://www.okeefe.com.ar/api/api/v1/zonaprop/publicaravisoxmldebug2/\"+id_parts[1]+\"/\"+id_parts[2]+\"/0\";
                                        $.get(urlTodebug,null, 'json')
                                        .done(function(data) {
                                            var obj = $.parseJSON( data );
                                            $('#mensaje').text(obj.description);
                                        })
                                        .fail(function() {alert(\"Error al validar propiedad\");});  
                                ...
                                },
                                {
                                  ...
                                  click: function(e) {
                                        ...
                                        var urlTopublicar = \"http://www.okeefe.com.ar/api/api/v1/zonaprop/publicaraviso/\"+id_parts[1]+\"/\"+$('#zp_responsable').val()+\"/\"+$('#zp_destacado').val()+\"/\"+id_parts[2];
                                        $.get(urlTopublicar,null, 'json')
                                        .done(function(data) {
                                            var obj = $.parseJSON( data );
                                            $('#mensaje').text(obj.description);
                                            //alert(\"Error al intentar retirar la propiedad\");
                                        })
                                        .fail(function() {alert(\"Error al intentar publicar la propiedad\");});
                                ...
                                },
                                {
                                  ...
                                  click: function(e) {
                                        ...
                                        var urlToretirar = \"http://www.okeefe.com.ar/api/api/v1/zonaprop/retiraraviso/\"+id_parts[1];
                                        $.get(urlToretirar,null, 'json')
                                        .done(function(data) {
                                            //$('#mensaje').text(data.description);
                                            var obj = $.parseJSON( data );
                                            $('#mensaje').text(obj.description);
                                        })
                                        .fail(function() {alert(\"Error al intentar retirar la propiedad\");});
         ...
         echo "$(\"a[id*='argenprop_']\").each(function() {
                $(this).click(function(event){;
                    event.preventBubble=true;
                    event.preventDefault();
                    ...
                    .done(function(data) {
                        ...
                        if(obj.status==404){
                            $('#mensaje').text(obj.description);
                            $('#content-publicacion').hide();
                            $('.argenprop .ui-dialog-buttonset button:nth-child(1)').hide();
                            $('.argenprop .ui-dialog-buttonset button:nth-child(2)').hide();
                            $('.argenprop .ui-dialog-buttonset button:nth-child(3)').hide(); 
                            errors=true;
                        }
                    })
                    .fail(function() {
                    ...
                    //chequeo si ya esta publicada en AP
                    ...
                    .done(function(data) {
                        ...
                        if(data.length!=0 && data.length>3){
                            ...
                            $('.argenprop .ui-dialog-buttonset button:nth-child(1)').hide();
                            $('.argenprop .ui-dialog-buttonset button:nth-child(2)').hide();      
                            $('.argenprop .ui-dialog-buttonset button:nth-child(3)').show();                   
                            errors=true;
                        }
                    })
                    .fail(function() {alert(\"Error al consultar registro AP\");});  

                    $(\"#ap_responsable option\").remove();      
                    ...
                    .done(function(data) {
                        ...
                        $(\"#zp_responsable\").append(\"<option value='0' SELECTED >Seleccione una opcion</option>\");
                        $.each(obj, function(index, val) {
                            $(\"#ap_responsable\").append(\"<option value=\"+val.key+\" >\"+val.value+\" </option>\")
                        });
                    })
                    .fail(function() {alert(\"Error al cargar responsables\");});                    
                    
                    if(!errors){
                            $('#content-publicacionap').show();
                            $('.ui-dialog-buttonset button:nth-child(1)').show();
                            $('.ui-dialog-buttonset button:nth-child(2)').show();                           
                            $('.ui-dialog-buttonset button:nth-child(3)').hide();  
                    }

                    var dialogap = $( \"#dialog-form-ap\" ).dialog({
                      autoOpen: true,
                      height: 320,
                      width: 450,
                      modal: true,
                             ...
                             /*
                                {
                                  ...
                                  click: function(e) {
                                        e.preventDefault();
                                        var urlTodebug = \"http://www.okeefe.com.ar/api/api/v1/argenprop/publicaravisoxmldebug2/\"+id_parts[1]+\"/\"+id_parts[2]+\"/0\";
                                        $.get(urlTodebug,null, 'json')
                                        .done(function(data) {
                                            var obj = $.parseJSON( data );
                                            $('#mensaje').text(obj.description);
                                ...
                                */
                                {
                                  ...
                                  click: function(e) {
                                        ...
                                        //var urlTopublicar = \"http://www.okeefe.com.ar/api/api/v1/argenprop/publicaraviso/\"+id_parts[1]+\"/\"+$('#ap_responsable').val()+\"/\"+$('#ap_destacado').val()+\"/\"+id_parts[2];
                                        var urlTopublicar = \"http://www.okeefe.com.ar/api/api/v1/argenprop/publicadebug/\"+id_parts[1]+\"/\"+$('#ap_responsable').val()+\"/\"+$('#ap_destacado').val()+\"/\"+id_parts[2];
                                        $.get(urlTopublicar,null, 'json')
                                        .done(function(data) {
                                            var obj = $.parseJSON( data );
                                            $('#mensaje').text(obj.description);
                                ...
                                },
                                {
                                  ...
                                  click: function(e) {
                                        ...
                                        var urlToretirar = \"http://www.okeefe.com.ar/api/api/v1/argenprop/retiraraviso/\"+id_parts[1];
                                        $.get(urlToretirar,null, 'json')
                                        .done(function(data) {
                                            //$('#mensaje').text(data.description);
                                            var obj = $.parseJSON( data );
...
//echo "PREVIO <br>";print_r($arrayDatos);
        //--------------------------------- Mostrar Resultados
        //print "<div id='userSesion' style='display:none'>".$_SESSION['UserId']."</div>";
    ...
    public function deslpiegaTabla($arrayDatos, $registros, $totalregs, $pagina,$sel) {
        ...
        print "<div id='vistaTabla' class='vistaTabla' style=\"width:835px;\">\n";  // DIV general de la tabla
//        print "    <ul>\n";
...
//        print "     </ul>\n";
        ...
        //EAJ
        print "     <div class='div_lista_titulo'  title='ZonaProp' style='text-align:center;float:left;width:30px;'>ZP</div>\n";        
        print "     <div class='div_lista_titulo'  title='ArgenProp' style='text-align:center;float:left;width:30px;'>AP</div>\n";        
        print "     <div class='div_lista_titulo'  title='SumaProp' style='text-align:center;float:left;width:30px;'>SP</div>\n";        
        //EAJ
        print "<div id=\"clearfix\"></div>\n";
...
//        $arrayEven = array_slice($arrayDatos, (($pagina - 1) * $registros), $registros);   // AGREGADO PARA UNIFICAR BUSQUEDA
        ...
        print "<div style='overflow:auto; clear:both; height:600px; width:848px;'>\n";
...
//                print $Even['id_sucursal'] . str_repeat("0", 5 - strlen(strval($Even['id_prop']))) . $Even['id_prop'];
                ...
                print "</div>\n";
                //EAJ
                print "<div id=\"inZP\"  style=\"float:left;padding-left:5px;\" ><a href='#' name='zonaprop_" . $Even['id_prop'] . "_" . $_SESSION['UserId']. " ' id='zonaprop_" . $Even['id_prop']  . "_" . $_SESSION['UserId']. "'><i class='fa fa-fw fa-expand' title='TEST - Operar con ZonaProp'></i></a> </div>\n";
                //<img src='images/zp.png' alt='ZonaProp' title='TEST - Operar con ZonaProp' />
                 //<i class="fa fa-fw fa-check"></i>
                 //<i class="fa fa-fw fa-times"></i>
                print "<div id=\"inAP\"  style=\"float:left;padding-left:15px;\" ><a href='#' name='argenprop_" . $Even['id_prop'] . "_" . $_SESSION['UserId']. " ' id='argenprop_" . $Even['id_prop']  . "_" . $_SESSION['UserId']. "'><i class='fa fa-fw fa-expand' title='TEST - Operar con ArgenProp'></i></a> </div>\n";
                print "<div id=\"inSP\"  style=\"float:left;padding-left:20px;\" title=\"TEST\">--</div>\n";
                //EAJ
                print "<div id=\"clearfix\"></div>\n";
                print " </div>\n";
            }
