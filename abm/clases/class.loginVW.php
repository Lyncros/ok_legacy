...
//		print "	encripta();\n";
		...
		print "function submitForm(){\n";
                print "    window.open('','ventanaCambio','width=300,height=200');\n";
		print "}\n";
...
//		print "</script>\n";
        ...
        echo "<form name='login' id='login' method='POST' enctype='multipart/form-data' action='registraCambioClave.php' target='ventanaCambio'  onsubmit='javascript: if(valida()){submitForm();};'>";
        print "	<table width='90%' align='center' bgcolor='#FFFFFF'>\n";
        print "<tr><td class='cd_celda_titulo' colspan='2'>Cambio de clave de Usuarios</td></tr>\n";
        echo "<tr>";
        echo "<td class='cd_celda_texto' width='35%'> Usuario :</td><td class='cd_celda_texto'><input type='hidden' name='id_user' id='id_user' value='" . $this->arrayForm['id_user'] . "'><input type='hidden' name='usuario' id='usuario' value='" . $this->arrayForm['usuario'] . "'><strong>" . $this->arrayForm['usuario'] . "</strong></td>";
        echo "</tr><tr>";
        echo "<td class='cd_celda_texto' width='35%'> Clave :</td><td class='cd_celda_texto'><input class='campos' type='Password' name='password' id='password' value='" . $this->arrayForm['clave'] . "'></td>";
        echo "</tr><tr>";
        echo "<td class='cd_celda_texto' width='35%'> Ingrese Nueva Clave :</td><td class='cd_celda_texto'><input class='campos' type='Password' name='npassword' id='npassword'></td>";
        echo "</tr><tr>";
        echo "<td class='cd_celda_texto' width='35%'> Confirme Nueva Clave :</td><td ><input class='campos' type='Password' name='rpassword' id='rpassword'></td>";
        echo "</tr>";

		echo "</tr><tr>";
		echo '<td colspan="2" align ="center">Codigo de Verificaci&oacute;n <img src="./securimage_show.php?sid='.  md5(uniqid()) .'" alt="" width="150" height="50" /><br /><br /><span class="titulos-01">Ingrese el Codio de Verificaci&oacute;n de la Imagen:</span> <input type="text" size="8" maxlength="8" name="captcha" id="captcha" value="" /></td>';
		echo "</tr><tr>";
