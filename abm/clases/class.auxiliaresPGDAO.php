...
class AuxiliaresPGDAO extends PGDAO {
	...
	public function coleccionTipopropCaracTasacion($_id_tipo_prop=0){
		$COLECCIONTIPOPROPCARAC = "SELECT a.id_carac,a.titulo,a.tipo,a.lista,t.tipo_carac,t.columnas FROM  #dbName#.caracteristica as a
											INNER JOIN #dbName#.tipocarac as t ON a.id_tipo_carac=t.id_tipo_carac
											INNER JOIN #dbName#.caracteristica_tipoprop as c ON c.id_carac=a.id_carac 
											WHERE c.id_tipo_prop=$_id_tipo_prop AND a.tasacion=1 ORDER BY t.orden,t.tipo_carac, a.orden ";
