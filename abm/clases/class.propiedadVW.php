...
//                $totalregs=$evenBSN->cantidadRegistrosFiltroBuscador($aux_codigo, $aux_calle, $idsZonas, $aux_prop, $aux_operacion, $aux_emp, $propsIN);
        ...
        if ($aux_vistaestado != 8 && $aux_vistaestado != 9) {
            ...
            $arrayDatos = $evenBSN->cargaColeccionFiltroBuscadorMapa($aux_codigo, $aux_calle, $idsZonas, $aux_prop, $aux_operacion, 
                $aux_emp, $propsIN, $pagina, $aux_campo, $aux_orden, $aux_vistaestado, $aux_vistazona);
            
            $totalregs = $evenBSN->cantidadRegistrosFiltroBuscador($aux_codigo, $aux_calle, $idsZonas, $aux_prop, $aux_operacion, 
                $aux_emp, $propsIN, -1, $aux_vistaestado);
        }
            ...
            foreach ($arrayEven as $Even) {
                ...
                switch ($Even['id_tipo_prop']) {
                    ...
                    case 15:
                        ...
                        break;
                    case 16:
                        $tipoProp = "<img src='' height='16' border='0' title='" . $Even['tipo_prop'] . "' />";
                        break;
                    case 17:
                        $tipoProp = "<img src='' height='16' border='0' title='" . $Even['tipo_prop'] . "' />";
                        break;
...
//                print $Even['id_sucursal'] . str_repeat("0", 5 - strlen(strval($Even['id_prop']))) . $Even['id_prop'];
                ...
                print "</div>\n";
                //EAJ APIS
                print "<div id=\"inZP\"  style=\"float:left;padding-left:5px;\" ><a href='#' name='zonaprop_" . $Even['id_prop'] . "_" . $_SESSION['UserId']. " ' id='zonaprop_" . $Even['id_prop']  . "_" . $_SESSION['UserId']. "'><i class='fa fa-fw fa-expand' title='Operar con ZonaProp'></i></a> </div>\n";
                print "<div id=\"inAP\"  style=\"float:left;padding-left:15px;\"><a href='#' name='argenprop_" . $Even['id_prop'] . "_" . $_SESSION['UserId']. " ' id='argenprop_" . $Even['id_prop']  . "_" . $_SESSION['UserId']. "'><i class='fa fa-fw fa-expand' title='Operar con ArgenProp'></i></a> </div>\n";
                print "<div id=\"inSP\"  style=\"float:left;padding-left:20px;\"><a href='#' name='sumaprop_" . $Even['id_prop'] . "_" . $_SESSION['UserId']. " ' id='sumaprop_" . $Even['id_prop']  . "_" . $_SESSION['UserId']. "'><i class='fa fa-fw fa-expand' title='Operar con SumaProp'></i></a> </div>\n";
                //EAJ  APIS
                print "<div id=\"clearfix\"></div>\n";
                print "	</div>\n";
            }
            ...
            if ($pagina > 1) {
                ...
                print "       <img src='images/resultset_first.png' alt='Inicio' title='Inicio' border='0' style='vertical-align: middle;'>";
                print "    </a>&nbsp;";
                print "    <a href='javascript:paginar(" . ($pagina - 1) . ");'>";
                print "       <img src='images/resultset_previous.png' alt='Anterior' title='Anterior' border='0' style='vertical-align: middle;'>";
                print "    </a>&nbsp;";
            ...
            if ($pagina < $paginas) {
                ...
                print "    <a href='javascript:paginar(" . ($pagina + 1) . ");'>";
                print "       <img src='images/resultset_next.png' alt='Siguiente' title='Siguiente' border='0' style='vertical-align: middle;'>";
                print "    </a>&nbsp;";
                print "    <a href='javascript:paginar($paginas);'>";
                print "       <img src='images/resultset_last.png' alt='Ultima' title='Ultima' border='0' style='vertical-align: middle;'>";
                print "    </a>&nbsp;";
            }
            print "</li>";
            print "</ul>";
...
//			}
            ...
            $mensaje .= "      <tr>\n";
            $mensaje .= "        <td><div><span style=\"font-weight:bold;\">Direcci&oacute;n:</span> <span class=\"caracResul\">" . $ubi . "</span><br />\n";
