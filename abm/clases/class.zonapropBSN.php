...
//Envio de datos a Zona Prop
    public function publicoPropiedad($id_user = 0, $clave = '', $destacado = 0) {
        if ($this->validUser($id_user, $clave)) {
            $xml = '';
            $xml = $this->armoXmlPublicarZP($destacado);
...
// Armado del XML     
    ...
    protected function armoXmlPublicarZP($destacado) {
        ...
        if($destacado != 0){
            ...
            $xml.='<expositionMethodType>'.$tipo_destacado.'</expositionMethodType>';
        }
            ...
            if ($finder == 0) {
                switch ($tipo) {
                    ...
                    case 19: // Industriales
                        ...
                        break;
                    case 20: // Industriales
                        $clave.='Negocios y Fondos de Comercio';
                        break;
                }
            }
        }
...
// LECTURA DE LOS COMPONENTES DESDE LAS TABLAS
    ...
    protected function registraRetiro() {
        $id_prop = $this->propiedad->getId_prop();
        $UPDATE = "UPDATE #dbName#.registropublicacion set fec_fin=now() where id_prop=$id_prop AND proveedor='ZonaProp' AND fec_fin is null;";
        $dao = new PGDAO();
    ...
    public function consultaRegistroPropiedad() {
        $id_prop = $this->propiedad->getId_prop();
        $FINDBYIDPROP = "SELECT * FROM #dbName#.registropublicacion WHERE id_prop=$id_prop AND proveedor='ZonaProp' ORDER BY id_registro DESC LIMIT 1;";
        $dao = new PGDAO();
    ...
    public function muestraColeccion($activas = -1) {
        ...
        $ubica = new UbicacionpropiedadBSN;
        ...
        print "  <table class='cd_tabla' width='100%' id='rowHandlers'>\n";
        print "    <tr>\n";
        print "     <td class='cd_lista_titulo'>C&oacute;digo</td>\n";
        print "     <td class='cd_lista_titulo'>C&oacute;digo ZP</td>\n";
        print "     <td class='cd_lista_titulo'>Zona</td>\n";
        print "     <td class='cd_lista_titulo'>Propiedad</td>\n";
        print "     <td class='cd_lista_titulo'>Tipo</td>\n";
        print "     <td class='cd_lista_titulo'>Operaci&oacute;n</td>\n";
       ...
       if($activas == 0){
        ...
        print "     <td class='cd_lista_titulo'>Publicó</td>\n";
        print "	  </tr>\n";
        ...
        if (sizeof($arrayEven) == 0) {
            ...
            foreach ($arrayEven as $Even) {
                ...
                switch ($prop->getObjeto()->getId_tipo_prop()) {
                    case 1:
                ...
                print "<tr>\n";
                print "	 <td class='row" . $fila . "' align='center'>" . $Even['id_prop'] . "</td>\n";
                print "	 <td class='row" . $fila . "' align='center'>" . $Even['id_zprop'] . "</td>\n";
                print "	 <td class='row" . $fila . "'>" . $ubica->armaNombreZonaAbr($prop->getObjeto()->getId_ubica()) . "</td>\n";
                print "	 <td class='row" . $fila . "'>" . $propiedad . "</td>\n";
                print "	 <td class='row" . $fila . "' align='center'>" . $tipoProp . "</td>\n";
                print "	 <td class='row" . $fila . "' align='center'>" . $prop->getObjeto()->getOperacion() . "</td>\n";
                print "	 <td class='row" . $fila . "' align='center'>" . $Even['fec_ini'] . "</td>\n";
               if($activas == 0){
