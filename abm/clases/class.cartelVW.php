...
class CartelVW extends VW{
	...
	public function cargaDatosVW(){
		...
		print "}\n";
		print "function muestracargaDataCartel(){\n";
		print "   document.getElementById('cargaDataCartel').style.display='block';\n";
		print "}\n";
		...
		print "<div id='cargaDataCartel' name='cargaDataCartel' style='display:none;'>";
...
//			print "     document.location.href='carga_Cartel.php?i='+prop+'&o='+cartel+'&b=b';\n";
		...
		$arrayTools=array(array('Nuevo','images/building_edit.png','muestracargaDataCartel()'),array('Regresar','images/ui-button-navigation-back.png','KillMe()'));
		$menu=new Menu();
