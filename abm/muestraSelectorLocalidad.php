...
print "         window.opener.document.getElementById('fid_loca').value=seleccion[0];\n";
print "         window.opener.document.getElementById('aux_loca').value=seleccion[0];\n";
print "         window.opener.document.getElementById('aux_selloca').value=seleccion[1];\n";
//print "         window.opener.document.getElementById('seleccionLocalidad').innerHTML=seleccion[1];\n";
print "         window.close();\n";
//print "         parent.tb_remove(true)";
print "     }\n";
...
print " 		   if(f.elements[n].checked && pref=='loc'){\n" ;
...
print "             <tr><td class=\"cd_lista_filtro\">Seleccione las Localidades deseadas</td></tr>\n";
print "             <tr><td>\n";
$locaBSN->checkboxLocalidad($valor,$zona);
print "             </td></tr>\n";
