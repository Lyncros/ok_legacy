...
<?php //echo  $prop[0]['fec_ini']." - " .$prop[0]['fec_fin'];
	if($prop[0]['fec_ini'] == '' || ($prop[0]['fec_ini'] != '' && $prop[0]['fec_fin'] != '' )){ ?>
	...
	<div style="clear:both;"></div>
<div id="responsable" style="width: 300px; padding: 10px;">Tipo de Destacado
    <select name='destacado' id='destacado' class='campos_btn'>
        <option value='0' SELECTED >Seleccione una opcion</option>
        <option value='1'>Destaque normal</option>
        <option value='3'>Destaque Premiun</option>
    </select>
</div>
