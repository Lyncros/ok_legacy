...
if (! $validador->ocurrieronErrores ())
{
	...
	// envia el mail
	enviar_mail ("juancruz@okeefe.com.ar", "Nuevo mensaje desde la landing AGUAS", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
	//enviar_mail ("ivanberlot@gmail.com", "Nuevo mensaje desde la landing AGUAS", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
	//enviar_mail ("victoria@eldodo.com.ar", "Nuevo mensaje desde la landing AGUAS", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
