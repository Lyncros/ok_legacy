...
$validador->validarCampoForm ("tipoPropiedad");
...
{
	// mensaje para mail
	$mensaje .= "<b>Tipo de propiedad:</b> " . $_POST['tipoPropiedad'] . " <br/>";
	...
	$db->query ("INSERT INTO contacto SET fechaAlta=CURDATE(), tipoPropiedad='" . $_POST['tipoPropiedad'] . "',nombre='" . $_POST['nombre'] . "',apellido='" . $_POST['apellido'] . "', email='" . $_POST['email'] . "', tel='" . $_POST['tel'] . "', consulta='" . $_POST['consulta'] . "'" . $sqlUTM);
	

	// envia el mail
	enviar_mail ("juancruz@okeefe.com.ar", "Nuevo mensaje desde la landing NUEVO QUILMES", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
	//enviar_mail ("ivanberlot@gmail.com", "Nuevo mensaje desde la landing NUEVO QUILMES", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
	//enviar_mail ("victoria@eldodo.com.ar", "Nuevo mensaje desde la landing NUEVO QUILMES", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
