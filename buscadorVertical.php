  ...
  <form action="busqueda.php" name="buscador" id="buscador" method="GET" onsubmit="actualizaDesdeHasta(); actualizaUbica();">
    <div style="width:235px;">
      ...
      <div>
		...
		<div id="Localidad">
          <input name="loc" id="loc" class="btn_localidad" type="button" onClick="abreSelector();" value="Localidades" style="color:#000; text-align:left; padding-left: 8px;" />
          </div>
...
<map name="Map" id="Map">
  <area shape="rect" coords="1,1,18,17" href="https://www.facebook.com/okeefeinmobiliaria?fref=ts" target="_blank" />
