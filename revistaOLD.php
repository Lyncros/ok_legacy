...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="contenedor-ppal" class="contenedor izquierdo">
...
<!--
                    <div class="chk_box_izq">
                        <input type="checkbox" />
                    </div>
                    <div class="chk_box_der">
                        <input type="checkbox" />
                    </div>
-->
                </div>
            ...
            <div class="thumbnails">
                <div>
                    <ul>
                        <li class="i"> <img src="digital/thumb/1.jpg" width="50" height="71" class="page-1"> <span>1</span> </li>
                        <?php
                        $cantPages = 80;
                        $pages = "";
                        for ($i = 2; $i <= $cantPages; $i = $i + 2) {
                            ...
                            ?>
                            <li class="<?php echo $clase; ?>"> <img src="digital/thumb/<?php echo $i; ?>.jpg" width="50" height="71" class="page-<?php echo $i; ?>">
                                    <?php
                                    if ($i < $cantPages) {
                                        $page .= " - " . ($i + 1);
                                        ?>
                                        <img src="digital/thumb/<?php echo $i + 1; ?>.jpg" width="50" height="71" class="page-<?php echo $i + 1; ?>">
                                        <?php } ?>
...
<!--                    <input type='button' name='contact' value='Solicitar Informacion' class='contact demo'/>  -->
