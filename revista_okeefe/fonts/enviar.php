...
if (! $validador->ocurrieronErrores ())
{
	...
	$db->query ("INSERT INTO contacto SET fechaAlta=CURDATE(), nombre='" . $_POST['nombre'] . "',apellido='" . $_POST['apellido'] . "', email='" . $_POST['email'] . "', tel='" . $_POST['tel'] . "', calle='" . $_POST['calle'] .  "',numero='" . $_POST['numero'] . "',localidad='" . $_POST['localidad'] . "',cp='" . $_POST['cp'] . "'" . $sqlUTM);
	...
	//enviar_mail ("victoria@eldodo.com.ar", "Nuevo mensaje desde la landing REVISTA", $mensaje, $_POST['email'], $_POST['apellido'].", ".$_POST['nombre']);
