...
<?php include_once('cabezalBuscador.php'); ?>
  ...
  ?>
  <a href="form_consulta_prop.php?id=<?php echo $lista; ?>&t=&TB_iframe=true&height=320&width=800&modal=false" class="thickbox consultarFavoritos" rel="nofollow"><?php echo $txtConsultar; ?></a>
...
*/        
  ...
  <div id="placaNaranja" style="clear:both;"><a href="form_consulta_buscador.php?TB_iframe=true&height=440&width=800&modal=false" class="thickbox"><img src="images/sinoencuentra.gif" width="702" height="18" border="0" /></a></div>
  <?php 
